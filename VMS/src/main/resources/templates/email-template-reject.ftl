...
<title>Rejected Requested MailService</title>
</head>
					...
					<tr>
						<td align="center" valign="top" bgcolor="#d3be6c"
							...
							<div style="font-size: 48px; color:blue;">
								<b>Rejected Requested MailService</b>
							</div>
							
							<div style="font-size: 24px; color: #555100;">
								<br>Sorry your application has been rejected<br>
							</div>
							<div>
								<br> This is the Rejected Email<br> 
